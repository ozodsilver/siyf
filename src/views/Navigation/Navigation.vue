<template>
  <div>
    ...
    <Menu as="div" class="relative inline-block text-left">
      <div>
        <MenuButton
          class="inline-flex w-full justify-center  px-2  items-center rounded-lg text-white  focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75"
        >
          uz
          <i class="fas fa-chevron-down text-sm mx-2  text-violet-200 hover:text-violet-100"  aria-hidden="true"></i>
